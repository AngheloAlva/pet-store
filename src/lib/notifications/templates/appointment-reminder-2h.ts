...
export function render(data: Data): { subject: string; html: string; text: string } {
  ...
  const subject = `Recordatorio (2h) — ${data.serviceName} en 2 horas`;
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background: #ffffff; border-radius: 8px; overflow: hidden;">
          <tr>
            <td style="background: #7c3aed; padding: 24px 32px;">
              <p style="color: #ffffff; font-size: 20px; font-weight: bold; margin: 0;">Tu turno es en 2 horas</p>
            </td>
          </tr>
          <tr>
            <td style="padding: 32px;">
              <p style="font-size: 16px; color: #111827; margin: 0 0 16px;">Hola <strong>${data.userName}</strong>,</p>
              <p style="font-size: 15px; color: #374151; margin: 0 0 24px;">¡Tu turno está a punto de comenzar!</p>
