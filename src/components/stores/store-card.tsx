...
export function StoreCard({ store, isSelected, onSelect, registerRef }: Props) {
  ...
  return (
    <button
      ...
      className={cn(
        "block w-full text-left rounded-lg border border-border bg-background p-4 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40",
